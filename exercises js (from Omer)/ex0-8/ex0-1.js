...
var x = 7;
// - possible only with var create a variable and after that assign a string
// with its value being: He's got it!
let string;
string = "He's got it"

// 8. create a variable and assign a value on how much a restaurant bill is.
let bill = 500;
// 9. create a variable and assign a value on how much tax they should pay.
let tax = 0.13
